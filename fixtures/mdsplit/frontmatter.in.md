...
The rest of this text has been reused from the simplest case for processing inline [links][1] to reference-style links in a document with [YAML frontmatter][2]. It is easy to confuse a single YAML property with a "underline" style H2.
